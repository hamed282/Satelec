(function (window, document, $, undefined) {
    ...
    if (countdown_objects.length) {
      countdown_objects.each(function () {
        ...
        var countdown_target_days = $(
          ".countdown-value-days",
          countdown_object
        );
        var countdown_target_hours = $(
          ".countdown-value-hours",
          countdown_object
        );
        var countdown_target_minutes = $(
          ".countdown-value-minutes",
          countdown_object
        );
        var countdown_target_seconds = $(
      ...
      animation_objects.each(function () {
        ...
        if (animation_object.attr("data-cursor-animation-delay")) {
          $.extend(animation_css, {
            "-webkit-animation-delay": animation_object.data(
        ...
        if (animation_object.attr("data-cursor-animation-duration")) {
          $.extend(animation_css, {
            "-webkit-animation-duration": animation_object.data(
              "cursorAnimationDuration"
            ),
            "animation-duration": animation_object.data(
              "cursorAnimationDuration"
            ),
          });
        }
    ...
    if (header_1.length) {
      if (header_1.hasClass("-js-header")) {
        ...
        $(".c-header-1-searcher-close", header_1_searcher).on(
          "click",
          function () {
        ...
        // Direct links in mobile view
        $("li.direct > a", header_1).on("click", function (e) {
          // Allow the link to work normally even on mobile
          return e;
        });
    ...
    if (header_2.length) {
      if (header_2.hasClass("-js-header")) {
        ...
        // Direct links in mobile view
        $("li.direct > a", header_2).on("click", function (e) {
          // Allow the link to work normally even on mobile
          return e;
        });
      ...
      tab_1_objects.each(function () {
        ...
        if (tab_1_object.hasClass("-js-tab")) {
          ...
          if (items_nav.hasClass("active")) {
            ...
            var active_id = $(".c-tab-1-nav-link", active_item).data(
              "cursorTabId"
            );
            ...
            items_body
              .filter("[data-cursor-tab-id=" + active_id + "]")
              .addClass("active");
					} else {
            var first_item = items_nav.filter(":first");
            var first_id = $(".c-tab-1-nav-link", first_item).data(
              "cursorTabId"
            );
            first_item.addClass("active");
            items_body
              .filter("[data-cursor-tab-id=" + first_id + "]")
              .addClass("active");
          }
          ...
          $(".c-tab-1-nav-link", items_nav).on("click", function (e) {
            ...
            link_parent.addClass("active");
            items_body
              .filter("[data-cursor-tab-id=" + link_id + "]")
              .addClass("active");
          });
        }
      });
    ...
    if (tab_2_objects.length) {
      tab_2_objects.each(function () {
        ...
        if (tab_2_object.hasClass("-js-tab")) {
          ...
          if (items_nav.hasClass("active")) {
            var active_item = items_nav.filter(".active:first");
            var active_id = $(".c-tab-2-nav-link", active_item).data(
              "cursorTabId"
            );
            items_nav.removeClass("active");
            items_body.removeClass("active");
            ...
            var first_item = items_nav.filter(":first");
            var first_id = $(".c-tab-2-nav-link", first_item).data(
              "cursorTabId"
            );
            first_item.addClass("active");
            items_body
    ...
    if (tab_3_objects.length) {
      tab_3_objects.each(function () {
        ...
        if (tab_3_object.hasClass("-js-tab")) {
          ...
          if (items_nav.hasClass("active")) {
            var active_item = items_nav.filter(".active:first");
            var active_id = $(".c-tab-3-nav-link", active_item).data(
              "cursorTabId"
            );
            items_nav.removeClass("active");
            items_body.removeClass("active");
            ...
            var first_item = items_nav.filter(":first");
            var first_id = $(".c-tab-3-nav-link", first_item).data(
              "cursorTabId"
            );
            first_item.addClass("active");
            items_body
    ...
    if (tab_4_objects.length) {
      tab_4_objects.each(function () {
        ...
        if (tab_4_object.hasClass("-js-tab")) {
          ...
          if (items_nav.hasClass("active")) {
            var active_item = items_nav.filter(".active:first");
            var active_id = $(".c-tab-4-nav-link", active_item).data(
              "cursorTabId"
            );
            items_nav.removeClass("active");
            items_body.removeClass("active");
            ...
            var first_item = items_nav.filter(":first");
            var first_id = $(".c-tab-4-nav-link", first_item).data(
              "cursorTabId"
            );
            first_item.addClass("active");
            items_body
    ...
    if (tab_5_objects.length) {
      tab_5_objects.each(function () {
        ...
        if (tab_5_object.hasClass("-js-tab")) {
          ...
          if (items_nav.hasClass("active")) {
            var active_item = items_nav.filter(".active:first");
            var active_id = $(".c-tab-5-nav-link", active_item).data(
              "cursorTabId"
            );
            items_nav.removeClass("active");
            items_body.removeClass("active");
            ...
            var first_item = items_nav.filter(":first");
            var first_id = $(".c-tab-5-nav-link", first_item).data(
              "cursorTabId"
            );
            first_item.addClass("active");
            items_body
          ...
          if (typeof google === "object" && typeof google.maps === "object") {
            ...
            var map_1_style_dark = new google.maps.StyledMapType(
              ...
              center: new google.maps.LatLng(
                map_1_data.cursorMapLat,
                map_1_data.cursorMapLng
              ),
            ...
            if (map_1_data.cursorMapMarker !== false) {
							var map_1_icon = {
                url:
                  map_1_data.cursorMapMarker ||
                  "assets/img/icon-map-marker-purple.png",
    ...
    if (list_1_objects.length) {
      list_1_objects.each(function () {
        ...
        if (list_1_object.hasClass("-js-icon")) {
          ...
          list_1_item.prepend(
            '<span class="c-list-1-icon ' + list_1_icon + '"></span>'
          );
        }
      });
		}
    ...
    if (progress_1_objects.length) {
      progress_1_objects.each(function () {
        ...
        if (progress_1_object.hasClass("-js-progress")) {
          progress_1_object.waypoint(
            function (direction) {
              if (direction === "down") {
                var progress_1_element = $(this.element);
                var progress_1_value =
                  progress_1_element.data("cursorProgress") || 0;
                var progress_1_inner = $(
                  ".c-progress-1-inner",
                  progress_1_element
                );
    ...
    if (accordion_1_objects.length) {
      accordion_1_objects.each(function () {
        ...
        if (accordion_1_object.hasClass("-js-accordion")) {
          var accordion_1_multiple = accordion_1_object.data(
            "cursorAccordionMultiple"
          );
          ...
          $(".c-accordion-1-item.active", accordion_1_object).each(function () {
            $(".c-accordion-1-body", this).show();
					...
					// Items Click
          $(".c-accordion-1-header", accordion_1_object).on(
            "click",
            function () {
              ...
              if (accordion_1_item.hasClass("active")) {
                ...
                if (accordion_1_multiple !== true) {
                  $(
                    ".c-accordion-1-item.active .c-accordion-1-body",
                    accordion_1_object
                  ).slideUp();
                  $(
                    ".c-accordion-1-item.active",
                    accordion_1_object
                  ).removeClass("active");
							}
    ...
    if (countdown_1_objects.length) {
      countdown_1_objects.each(function () {
        ...
        if (countdown_1_object.hasClass("-js-countdown")) {
          ...
          var countdown_1_target_minutes = $(
            ".value-minutes",
            countdown_1_object
          );
          var countdown_1_target_seconds = $(
            ".value-seconds",
            countdown_1_object
          );
      ...
      portfolio_1_objects.each(function () {
        ...
        if (portfolio_1_object.hasClass("-js-isotope")) {
          ...
          if (portfolio_1_filter.length) {
            $("a[data-cursor-portfolio-filter]", portfolio_1_filter).on(
              "click",
              function (e) {
							e.preventDefault();
                var link_object = $(this);
